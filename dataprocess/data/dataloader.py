...
# Example of data loading, generating sequences, and splitting dataset
def preprocess_and_split_data(processed_data, T, F_future=None, step=2, train_ratio=0.7, val_ratio=0.1, test_ratio=0.2,
    ...
    (train_data, train_labels), (val_data, val_labels), (test_data, test_labels) = split_dataset(input_sequences,
                                                                                                 labels, train_ratio,
