...
if __name__ == '__main__':
    # 输入和输出文件夹路径
    input_folder = "/mnt/d/project/Java/rtree_construct/us101Data/03_RTreeToken"
    output_folder = "/mnt/d/project/Java/rtree_construct/us101Data/04_RTreeTokenContext"
